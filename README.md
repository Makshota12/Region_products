...
**Рисунок 3.8** - Регистрация пользователя в Postman (код `201`, тело ответа с полями пользователя).  
**Рисунок 3.9** - Успешный вход и получение JWT (`token`, `token_type`), использование токена в заголовке `Authorization`.
...
**Рисунок 3.10** - Экран результатов: общий индекс, графики по доменам, история индекса.  
**Рисунок 3.11** - Пример сравнения нескольких продуктов на дашборде.  
**Рисунок 3.12** - Успешная генерация и загрузка PDF-паспорта зрелости.
